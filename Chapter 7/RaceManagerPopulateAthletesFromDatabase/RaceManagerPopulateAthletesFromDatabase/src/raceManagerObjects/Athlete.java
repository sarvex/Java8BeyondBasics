...
public abstract class Athlete implements RaceParticipant, Person, Serializable {
  private static final long serialVersionUID = 5366283568916663374L;
  ...
  public abstract String performRaceActivitySafe();
  ...
  public String toString() {
    return String.format("%s]\tName: %s\tAge: %d\tRacerID: %d\t", getClass(), getName(), getAge(), getRacerId());
  }
  ...
  public String toDataString() {
    return String.format("name=%s;age=%d;id=%d;injured=%b", getName(), getAge(), getRacerId(), Boolean.valueOf(getIsInjured()));
  }
}
