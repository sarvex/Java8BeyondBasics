...
public class ShowDatabaseOperations {
  private static final String CONFIG_PATH = "C:\\JavaProjects\\MySQLDBDeleteData"
    ...
    try {
      ...
      while (!allDone) {
        ...
        case 6:
          ...
          System.out.println(
              "Please enter 1 to insert a new Runner, " + "2 to insert a new Biker, or 3 to insert a new Swimmer. ");
          userEntry = input.nextLine();
          Athlete a = null;
          if (userEntry.equals("1")) {
            a = new Runner();
        ...
        case 9:
          ...
          userEntry = input.nextLine();
          deleteAthlete(dbm, Integer.parseInt(userEntry));
