...
public class FunctionalInterfaces {
  ...
  public static void main(String[] args) {
    ...
    // predicate testing
    /*
     * System.out.println("What contains Value? " + containsValue.test("What?")); System.out.println(
     * "Value contains Value? " + containsValue.test("Value?"));
     */

    // again, we can use type inference:
    /*
     * System.out.println("32? " + isEven.test(32)); System.out.println("55? " + isEven.test(55));
     */

    // filter a collection
    /*
     * List<Integer> productIDs = new ArrayList<Integer>(); Random r = new Random(48915); for (int i = 0; i < 50; i++) {
    ...
    /*
     * for (Integer i : filteredIDs) { System.out.println("Next Value: " + i); }
     */
