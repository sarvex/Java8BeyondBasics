...
public class driver {
  ...
  public static void main(String[] args) {
    /*
     * //test cars from both files - old way no Dependency Injection: JSONAutoSearcher jsas = new
     * JSONAutoSearcher(JSONPath); AutoFinder af1 = new AutoFinder(jsas); af1.setMake("Ford");
     * 
     * PipeDelimitedTextAutoSearcher pdt = new PipeDelimitedTextAutoSearcher(txtPath); AutoFinder af2 = new
     * AutoFinder(pdt); af2.setMake("Chevy");
     */
