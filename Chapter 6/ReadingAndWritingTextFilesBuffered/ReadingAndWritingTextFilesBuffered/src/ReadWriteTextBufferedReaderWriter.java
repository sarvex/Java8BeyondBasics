...
public class ReadWriteTextBufferedReaderWriter {
  public static final String inputPath = "C:\\JavaProjects\\" + "ReadingAndWritingTextFilesBuffered\\src\\Racers.txt";
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      /*
       * nextLine = br.readLine(); while (nextLine != null) { System.out.println(nextLine); nextLine = br.readLine(); }
       */
