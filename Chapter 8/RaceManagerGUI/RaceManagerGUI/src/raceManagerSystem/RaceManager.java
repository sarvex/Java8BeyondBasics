...
public class RaceManager extends JFrame {
  ...
  private static final long serialVersionUID = 2956186165791834085L;
  ...
  public RaceManager() {
    ...
    String choice = JOptionPane.showInputDialog(
        "Enter 1 " + "to load the racers from the flat text file, 2 to load from the System state file");
