...
public class BasicRegexRules {
  /*
   * '.' ==> match any character [A-Za-z0-9!@# etc.. '^{...}' ==> match at start [starts with] //{...} denotes ANY REGEX
   * in this key '{...}$' ==> match at end [ends with] '[A-Za-z0-9]' ==> match any cap, any small, and 0-9 //can be
   * separated out to each. '[^somevalue] ==> doesn't match somevalue... '*' ==> Match ANY number of times '+' ==> Match
   * One or more times '?' ==> 0 or 1 times only '{n}' ==> match 'n' number of times '\w' ==> Matches a normal char and
   * underscore [A-Za-z0-9_] '\s' ==> matches whitespace '\d' ==> matches digit [0-9]
   */
