 ...
 *
 * @author sarvex This code is NOT intended for use. Here, I simply want to examine what a linking structure MIGHT look
 *         like under the covers. This is so we can get a better understanding of why certain data structures might work
 *         better in some circumstances */
public class SimpleSingleLinkedList<E> implements Iterable<E> {
  ...
  public void add(E data) {
    ...
    DataLink<E> newLink = new DataLink<>(data, prevLink);
    // increment the size
    size++;
  }
  ...
  public Iterator<E> iterator() {
    return new SimpleSingleLinkedListIterator<E>();
  }

  public Iterator<?> iterator(int index) {
    return new SimpleSingleLinkedListIterator<E>(index);
  }
   ...
   *
   * @param <E> */
  private class SimpleSingleLinkedListIterator<E> implements Iterator<Object> {
